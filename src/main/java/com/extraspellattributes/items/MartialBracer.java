...
public class MartialBracer extends TrinketItem {
    ...
    public Multimap<EntityAttribute, EntityAttributeModifier> getModifiers(ItemStack stack, SlotReference slot, LivingEntity entity, UUID uuid) {
        ...
        // +10% movement speed
        modifiers.put(ReabsorptionInit.GLANCINGBLOW, new EntityAttributeModifier(uuid, "extraspellattributes:bracerglancing", value, EntityAttributeModifier.Operation.MULTIPLY_BASE));
